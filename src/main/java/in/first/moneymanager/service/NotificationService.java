     ...
     public void sendDailyIncomeExpenseReminder(){
        ...
        for(ProfileEntity profile:profiles){
            String body="Hi"+profile.getFullName()+",<br><br>"
                    +"This is friendly reminder to add your income.<br><br>"
    ...
    public void sendDailyExpenseSummary(){
        ...
        for(ProfileEntity profile:profiles){
            ...
            if (!todaysExpenses.isEmpty()) {
                ...
                table.append("<tr style='border-color:#f2f2f2;><th style='border:1px solid #ddd;padding:8px;'>S.No</th><th style='border:1px solid #ddd;padding:8px';>Name</th><th style='border:1px solid #ddd;padding:8px;'>Amount</th><th style='border:1px solid #ddd;padding:8px;'>Category</th><th style='border:1px solid #ddd;padding:8px;'>Date</th></tr>");
                int i=1;
                ...
                table.append("</table>");
                String body="Hi "+profile.getFullName()+",<br><br><br> Here is a summary for today: <br/><br/>"+table+"<br/><br/>Best Regards";
                emailService.sendEmail(profile.getEmail(),"Your Daiy expense Summary",body);
            }
        }
