...
import in.first.moneymanager.entity.ExpenseEntity;
...
import in.first.moneymanager.repository.IncomeRepository;
...
//    private final IncomeRepository incomeRepository;
    ...
    //retureve all expenses for current month/based on the start date and end date
    ...
    //Notification
    public List<ExpenseDTO> getExpensesForUserOnDate(Long profielId,LocalDate date){
        List<ExpenseEntity> list=expenseRepository.findByProfileIdAndDate(profielId,date);
        return list.stream().map(this::toDTO).toList();
    }
